...
BUILTINS	= 
EXEC		= exec/main.c exec/parent.c exec/child.c exec/open.c exec/close.c exec/execve.c exec/convert_envp.c exec/envp_utils.c $(BUILTINS)
UTILS		= utils/split.c utils/utils_1.c utils/utils_2.c utils/utils_3.c utils/utils_4.c
